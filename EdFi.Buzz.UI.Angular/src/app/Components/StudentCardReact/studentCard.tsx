  ...
  return (
    <StyledStudentCard className="card">
      <div className="card-body p-t-0">
        <div className="d-flex p-t-12">
          ...
          <div className="flex-grow-1 overflow-hidden">
            ...
            {!student.primaryemailaddress && (
              <p className="alert alert-primary">No email</p>
            )}
          </div>
        </div>
          ...
          {student.contacts && student.contacts.length > 0 && (
            <div className="primary-contact">
              <div className="primary-contact-name">
                Primary Contact&nbsp;-&nbsp;<i>{student.contacts[0].relationshiptostudent}</i>{" "}
                {student.contacts[0].contactlastname},{" "}
              ...
              <div className="primary-contact-phone">
                <a
                  ...
                  href="tel:{{student.contacts[0].phone}}"
                >
        ...
        <div className={`collapse ${isCollapsed ? "show" : ""}`}>
          ...
          {student.contacts && student.contacts.length > 0 && (
            <p className="m-l-10">
              ...
              <a
                className="m-b-2 "
                href="mailto:{{student.contacts[0].primaryemailaddress}}"
              >
              ...
              <span className="text-muted">
                <a href="tel:{{student.contacts[0].phonenumber}}">
                  {student.contacts[0].phonenumber}
                </a>
              </span>
              <span className="text-muted block">
                {student.contacts[0].streetnumbername}{" "}
                {student.contacts[0].apartmentroomsuitenumber}
              </span>
            </p>
          )}
          {(!student.contacts || student.contacts.length === 0) && (
          ...
          {student.contacts &&
            student.contacts.length > 0 && (
              <h4>
                ...
                <span className="text-muted">
                  {student.contacts[0].preferredcontactmethod}
                </span>
              </h4>
            ) && (
              <h4>
                ...
                <span className="text-muted">
                  {student.contacts[0].besttimetocontact}
                </span>
              </h4>
            )}
      ...
      <div className="footer card-footer">
        <div>{!isCollapsed ? "View more": "View less"}</div>
        <img
          className={!isCollapsed ? "" : "flip"}
          src={OrangeChevron}
