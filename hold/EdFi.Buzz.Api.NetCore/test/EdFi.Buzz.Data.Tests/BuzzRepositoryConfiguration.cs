...
namespace EdFi.Buzz.Data.Tests
{
    public class BuzzRepositoryConfiguration
    {
        protected BuzzRepositoryConfiguration(DbContextOptions<BuzzContext> contextOptions)
        {
            ContextOptions = contextOptions;

            Seed();
        }
        protected DbContextOptions<BuzzContext> ContextOptions { get; }
